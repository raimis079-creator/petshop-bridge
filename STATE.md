...
> Paskutinį kartą atnaujinta: **2026-07-14 vakaras** (po S187 — Petshop_Action_Tokens (M6) gyvas: HMAC signed tokens, scanner-safe, key rotation, 9/9 testų).
...
| **deployment_log** | **v1.3.54** | `dokumentai/deployment_log_v1_3_54.md` | S-numeruota deploy istorija — *kas pastatyta + kodėl* (iki S187) |
