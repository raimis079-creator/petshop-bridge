...
> Paskutinį kartą atnaujinta: **2026-07-14 vakaras** (po S188 — Event Registry + 2 realūs event'ai (order_paid, consent_changed) gyvi, core v0.3.0).
...
| **deployment_log** | **v1.3.55** | `dokumentai/deployment_log_v1_3_55.md` | S-numeruota deploy istorija — *kas pastatyta + kodėl* (iki S188) |
