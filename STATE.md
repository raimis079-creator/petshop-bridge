...
**★ canonical_table_hash PASTABA:** S212-B hash algoritmas buvo deaktyvuotame snippete (neatkurtas: 4 bandymai + kodo paieška nerado). Naujos 3 lentelės naudoja `canonical_hash_version='chash_s212c_v1'` (aiškiai pažymėta, kad kito metodo — nekonfliktuoja su chash_v1 re-import). Hash deterministinis; runtime invariantas tikrina tik NOT NULL.
