<?php
/**
 * Petshop Attr Modulis: Grauziko Rusis v1.2 (multi-tag parseris + dry/apply)
 *
...
function petshop_grauzrusis_species( $hay ) {
    ...
    if ( strpos( $hay, 'trius' ) !== false ) { $out[] = "Dekoratyvinis triu\xC5\xA1iukas"; }                    /* Triusis */
...
add_action( 'init', function () {
    ...
    echo '<h2>Grauziko Rusis v1.2 &mdash; ' . ( $do_write ? 'APPLY' : 'DRY-RUN' ) . '</h2>';
