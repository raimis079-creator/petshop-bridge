...
/*
 * MIGRACIJA (S186): Perkelta iš petshop-esp/includes/class-consent-log.php.
 * Klase Petshop_ESP_Consent_Log pervadinta i Petshop_Consent_Log.
 * DB lentele gaj6_ps_consent_log ta pati.
 * petshop-esp v0.4.0 palieka class_alias backward compat.
 */
class Petshop_Consent_Log {
