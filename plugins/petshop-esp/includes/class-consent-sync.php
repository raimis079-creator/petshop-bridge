...
class Petshop_ESP_Consent_Sync {
	...
	public static function set_marketing_consent( $email, $consent, $source = 'unknown', $customer_id = 0 ) {
		...
		$from = Petshop_ESP_Consent_Log::current_value( $email, 'marketing_consent' );
		...
		Petshop_ESP_Consent_Log::record( array(
