...
try{
  ...
  const puslapiai=[
    ['s1547f_kl','/wp-admin/admin.php?page=ps-klientai&saltinis=abu&f_brendas=josera&f_gyvunas=suo&f_nuo=2025-01-01&f_iki=2025-12-31'],
    ['s1547f_kl_riz','/wp-admin/admin.php?page=ps-klientai&tab=rizika&saltinis=abu&f_brendas=josera'],
    ['s1547f_pr','/wp-admin/admin.php?page=ps-prekes&saltinis=abu&f_gyvunas=kate'],
    ['s1547f_at','/wp-admin/admin.php?page=ps-atsargos&saltinis=abu&f_brendas=animonda'],
  ];
