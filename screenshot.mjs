...
const B64=''; const SHA='a6ab6fd18b5aa9424c4aef562e329e28b3782576'; const MD5='beee4b5c1118a509f58b474f8edeb7a4';
const out={v:'H294A'}; const miegok=ms=>new Promise(r=>setTimeout(r,ms));
...
let sid=null;
try{
  const c=await fx(SNIP,{method:'POST',headers:A,body:JSON.stringify({name:'TEMP H290 v1 (rinkiniai v1.38)',code:Buffer.from(B64,'base64').toString('utf8'),scope:'global',active:true,priority:5})},'snip');
  const j=JSON.parse(await c.text()); out.sukurta=j.id; sid=j.id; await miegok(9000);
  const d=await fx(WP+'/?ps_h294=RUN20260825AD&deploy=1&sha='+SHA,{},'deploy');
  ...
  if(out.md5_ok&&cookies.length){
    ...
    out.animonda={id:an,url:pg.url().replace(WP,''),
      ...
      zenklas:await pg.$eval('body',n=>getComputedStyle(n).getPropertyValue('--ps-rink-zenklas')),
    ...
    out.anim_put=await put('screenshots/h294_animonda.png',await pg.screenshot({fullPage:false}),'H294A');
    ...
    out.js=kl;
    out.put=await put('screenshots/h294_admin.png',await pg.screenshot({fullPage:false}),'H294A');
    await br.close();
  }
...
await put('screenshots/h294run.json', Buffer.from(JSON.stringify(out,null,1)), 'H294A');
