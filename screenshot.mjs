...
// Code Snippets REST API: /wp-json/code-snippets/v2/snippets/{id}
try{
  const r=execSync(`curl -sk --max-time 30 -u "$WP_USER:$WP_PASS_CLEAN" "https://dev.avesa.lt/wp-json/code-snippets/v2/snippets/512?fields=code,name,desc,scope,active"`,{env:env2,encoding:'utf8',maxBuffer:50000000});
  commit('snippet_512.json',r);
  console.log("done, size=",r.length);
