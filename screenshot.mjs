...
const TS="1782141345";
const raw=execSync(`curl -sk --max-time 50 "https://dev.avesa.lt/?ps_yith_dump=1&k=ps2026"`,{encoding:'utf8',maxBuffer:20000000});
let parsed; try{ parsed=JSON.parse(raw); }catch(e){ parsed={raw:raw.slice(0,4000)}; }
putResult('yithdump_'+TS+'.txt', parsed);
