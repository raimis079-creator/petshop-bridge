...
const out={v:'S1583po'}; const br=await chromium.launch(); const ctx=await br.newContext({viewport:{width:1366,height:900},ignoreHTTPSErrors:true}); const pg=await ctx.newPage();
