...
const out={};
for(const id of [12452,14771,12466,13019,12928]){const T=readRaw(id);if(T===null){out[id]={ERR:1};continue;}
  const iM=T.indexOf(MARK);out[id]=iM>-1?T.slice(iM,iM+700):"NO_MARK";}
commit("euk_feed_"+Date.now()+".json", JSON.stringify(out,null,1));
console.log("DONE");
