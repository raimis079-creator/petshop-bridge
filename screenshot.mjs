...
const out={};
for(const id of [14794,14770,12458]){const T=readRaw(id);if(T===null){out[id]={ERR:1};continue;}
  const iM=T.indexOf(MARK);
  out[id]={raw:T.slice(iM, iM+900)};}
commit("euk_flag_"+Date.now()+".json", JSON.stringify(out,null,1));
console.log("DONE");
