...
const SENS={comp:"Antienos miltai (29,0%), bulvių krakmolas, žirniai, jautienos taukai, bulvių baltymas, cikorija, celiuliozė, saulėgrąžų aliejus, fruktooligosacharidai (FOS), kalio chloridas, dumblių aliejus (0,3%), mielių hidrolizatas.",
  anal:"Drėgmė 9,0%, žali baltymai 25,0%, žali riebalai 10,0%, žali pelenai 7,0%, žalia ląsteliena 3,5%. Mineralinės medžiagos: kalcis 1,4%, fosforas 0,9%, kalis 0,6%, magnis 0,1%, natris 0,4%.",
  energy:"3489 kcal/kg",
  cols:["Kūno svoris","Mažas aktyvumas","Vidutinis aktyvumas","Didelis aktyvumas"],
  rows:[["2,5","55","65","75"],["5","95","110","125"],["7,5","125","145","170"],["10","155","180","210"],["15","210","245","285"],["20","260","300","355"],["25","305","355","420"],["30","350","405","480"],["35","395","455","540"],["40","435","505","595"],["45","475","550","650"],["50","515","595","705"],["55","550","640","755"],["60","590","680","805"],["65","625","725","855"],["70","660","765","905"],["80","730","845","1000"]]};
const REC={16868:SENS,16865:SENS};
...
if(!ok){commit("prins_sens_"+Date.now()+".json",JSON.stringify({abort:1,rep},null,1));console.log("ABORT");process.exit(0);}
const wres={};
...
commit("prins_sens_"+Date.now()+".json",JSON.stringify({rep,wres},null,1));
console.log("SENS DONE");
