const S='';
...
const o={};
const mk=wj('POST','code-snippets/v1/snippets',{name:'S212-C Set Prov (read-only)',code:Buffer.from(S,'base64').toString('utf8'),scope:'front-end',active:true,priority:10});
let id=null; try{const j=JSON.parse(mk); id=j.id; o.create={id:j.id,code_error:j.code_error||null};}catch(e){o.mk=mk.slice(0,250);}
if(id){ const r=hit('https://dev.avesa.lt/?ps_sp=Sp8Kw3Nx&confirm=APPLY_SETPROV');
  const i=r.indexOf('{"');
