...
// === RECEPTAS ===
const RECEPTAS = {
  pavadinimas: "Vandenynas — kačių jūros konservų rinkinys",
  sku: "RINK-VANDENYNAS-CAT-11",
  kaina: 17.99,
  dydis: 11,
  kategorija_slug: "konservu-rinkiniai",
  trumpas_aprasymas: "11 skirtingų jūros gėrybių skonių katėms. Lengvai virškinami konservai rekomenduojami išrankioms, vyresnėms, sterilizuotoms ir antsvorio turinčioms katėms.",
  komponentai: [
    { id: 16942, kiekis: 1 }, // Ontario lašišos pasta 90g
    { id: 17057, kiekis: 1 }, // Ontario vištiena+lašiša 95g
    { id: 17499, kiekis: 1 }, // Miamor tunas+kalmarai 100g
    { id: 17493, kiekis: 1 }, // Miamor tunas+krevetės 100g
    { id: 18369, kiekis: 1 }, // Miamor Vitaldrink TUNO 135ml
    { id: 19045, kiekis: 1 }, // CATIT tuno paštetas 95g
    { id: 19452, kiekis: 1 }, // Animonda Mild Menu kalakutiena+lašiša 100g
    { id: 17550, kiekis: 1 }, // Miamor Feine Filets tunas krabų drebučiuose
    { id: 17547, kiekis: 1 }, // Miamor Feine Filets tunas lašišos drebučiuose
    { id: 17538, kiekis: 1 }, // Miamor Feine Filets tunas SU krabais drebučiuose
