...
const SKIP=new Set([17415,17418,12555,12829,13871,14274,17394,17400,17403,17406,17409,17412,17421]);
...
for(const id of IDS){
  ...
  const sIdx=decoded.search(/Šėrimo\s+(?:instrukcij|rekomendacij)/);
  let pEnd=-1;
  if(sIdx>=0){
  ...
  const g={
    ...
    hasSerimo:/Šėrimo\s+(?:instrukcij|rekomendacij)/.test(newT),
