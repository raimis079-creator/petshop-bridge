...
(async()=>{
  ...
  const slugs=[
    'all-breeds-adult-chicken','puppy-junior','classic','monoprotein-all-breeds-beef',
    'all-breeds-adult-rich-in-chicken','monge-natural-superpremium-all-breeds-adult-monoprotein-chicken-with-rice-and-potatoes',
    'all-breeds-adult-monoprotein-chicken-with-rice-and-potatoes','monoprotein-all-breeds-chicken',
    // BWild konservai Puppy Duck (17412 cs)
    'grain-free-irregular-cut-chunkies-in-gravy-duck-with-pumpkin-and-zucchini-puppy-junior',
    'grain-free-irregular-cut-chunks-in-gravy-duck-with-pumpkin-and-zucchini-puppy',
    'grain-free-irregular-cut-chunkies-in-gravy-duck-with-pumpkin-puppy-junior',
    // Special Dog Excellence All Breeds Puppy & Junior
    'all-breeds-puppy-junior',
    // Monoproteico Solo (turi konservai, tikriausiai TXT formato)
    'monoproteico-solo-anatra','monoproteico-solo-agnello','monoproteico-solo-tacchino',
    // Mini Senior Sterilised
    'mini-senior-sterilised','sensitive-sterilised','sensitive-light',
    // BWild GF Cat Anchovies
    'grain-free-anchovies-cat','grain-free-anchovies-adult-cat',
    // Spec.Line Mini Adult Pork
    'mini-adult-con-maiale-riso-e-patate'
  ];
  const out={};
  let total=0;
  ...
  await ctx.close();
  await browser.close();
  commit('monge_pdfs6.json',JSON.stringify({total,results:out},null,1));
