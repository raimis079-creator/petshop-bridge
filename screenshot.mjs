...
try{
  ...
  const c=await fx(SNIP,{method:'POST',headers:A,body:JSON.stringify({name:'TEMP PS Katalogo Diegimas v1.7 (dydziu seima)',
...
await put('analize/dieg10_status.json', Buffer.from(JSON.stringify(out,null,1)), VER);
console.log('ok');
