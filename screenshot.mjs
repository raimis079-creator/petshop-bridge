...
(async()=>{
  ...
  const slugs=[
    // Lamb variantai
    'extra-small-adult-con-agnello-riso-e-patate',
    'mini-adult-con-agnello-riso-e-patate',
    'mini-puppy-junior-con-agnello-e-riso',
    'grain-free-lamb-with-potatoes-and-peas-all-breeds-adult',
    // BWild Anchovies CAT
    'low-grain-anchovies-adult',
    // CAT Buffalo
    'low-grain-buffalo-large-breeds-cat','large-breeds-buffalo-cat','grain-free-large-breeds-buffalo',
    // Pork (mini, extra small variantai)
    'mini-adult-monoprotein-pork-with-rice-and-potatoes',
    'mini-puppy-junior-monoprotein-pork-with-rice-and-potatoes',
    'extra-small-adult-monoprotein-pork',
    // Hare DOG variantai
    'low-grain-hare-all-breeds-adult','low-grain-hare-adult-dog',
    'all-breeds-adult-monoprotein-hare',
    // Konservai
    'fresh-pate-and-chunkies-chicken','fresh-pate-and-chunkies-veal',
    'pate-and-chunkies-with-chicken','pate-and-chunkies-with-veal',
    // Monoproteico Solo
    'solo-agnello','solo-anatra','solo-tacchino',
    'monoprotein-solo-lamb','monoprotein-solo-duck','monoprotein-solo-turkey',
    // BWild puppy duck konservai
    'grain-free-irregular-cut-chunkies-in-gravy-duck-with-pumpkin-and-zucchini-puppy',
  ...
  await ctx.close();
  await browser.close();
  commit('monge_pdfs5.json',JSON.stringify({total,results:out},null,1));
