...
try{
  ...
  const puslapiai=[
    ['s1549_tk','/wp-admin/admin.php?page=ps-atsargos&tab=tiketini&saltinis=abu'],
    ['s1549_tk30','/wp-admin/admin.php?page=ps-atsargos&tab=tiketini&tk_d=30&saltinis=abu'],
  ];
