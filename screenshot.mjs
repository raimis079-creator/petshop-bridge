...
(async()=>{
  ...
  const probe = await page.evaluate(()=>({
    ...
    has_please_select_en: document.body.textContent.includes('Please select')
  }));
  commit('vitrina_v7_check.json', JSON.stringify(probe,null,1));
  putBin('vitrina_v7.png', await page.screenshot({fullPage:false}));
