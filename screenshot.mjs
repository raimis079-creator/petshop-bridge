...
// === RECEPTAS ===
const RECEPTAS = {
  pavadinimas: "Animonda GranCarno rinkinys · 6×400g",
  sku: "RINK-ANIMONDA-GC-6x400",
  kaina: 13.49,
  dydis: 6,
  kategorija_slug: "konservu-rinkiniai",
  trumpas_aprasymas: "6 skirtingi Animonda GranCarno skoniai — su jautiena, antiena, žvėriena, elniena, lašiša, jautiena+ėriena. Be grūdų, sojų, cukraus, dirbtinių dažiklių ir konservantų.",
  komponentai: [
    { id: 19574, kiekis: 1 }, // GranCarno Beef (jautiena)
    { id: 19566, kiekis: 1 }, // GranCarno Duck (antiena)
    { id: 19500, kiekis: 1 }, // GranCarno žvėriena
    { id: 19492, kiekis: 1 }, // GranCarno elniena + obuoliai
    { id: 19483, kiekis: 1 }, // GranCarno lašiša + špinatai
