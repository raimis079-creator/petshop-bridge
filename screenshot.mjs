...
(async()=>{
  var out={};
  var base='https://dev.avesa.lt/kategorija/katems/tualetai-kraikai-semtuveliai?yith_wcan=1&product_cat=tualetai-kraikai-semtuveliai&query_type_tipas=or&filter_tipas=';
  var tests = { 'uzdaras-namelis':23, 'kilimelis':13 };
  try{
    ...
    for (var slug in tests){
      ...
      try{
        await p.goto(base+slug,{waitUntil:'domcontentloaded',timeout:40000});
  ...
  commit('final_click.json', Buffer.from(JSON.stringify(out),'utf8').toString('base64'));
