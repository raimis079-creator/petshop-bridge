...
for(const pid of ['12461','12462']){
  ...
  try{
    ...
    const before=JSON.parse(execSync(`curl -sk --max-time 40 -u "$WP_USER:$WP_PASS_CLEAN" "https://dev.avesa.lt/wp-json/wc/v3/products/${pid}?_fields=id,description"`,{encoding:'utf8',env,maxBuffer:20000000}));
