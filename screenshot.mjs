...
const analitines='\n<p><strong>Analitin\u0117s sudedamosios dalys:</strong></p>\n<p>Baltymai 20,0 %, riebal\u0173 kiekis 11,0 %, \u017dalia l\u0105stelien\u0105 2,6 %, \u017dali pelenai 8,2 %, kalcis 1,90 %, fosforas 1,10 %, natris 0,45 %, magnis 0,11 %, taurinas 1 000 mg/kg. Metabolizuojama energija: 14,8 MJ/kg (3 536 kcal/kg).</p>';
...
putResult('lamb2_'+TS+'.json', JSON.stringify(out,null,2));
