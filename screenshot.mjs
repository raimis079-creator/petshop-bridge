...
for (const f of ['petshop-gavimas.php']) {
  try{
    const gg=await fetch(`https://api.github.com/repos/${REPO}/contents/deploy/${f}.b64?ref=6d37dfd319d52245a75fb60680f238b9eaf74bbc`,{headers:{'Authorization':'Bearer '+TOK}});
...
try{
  ...
  await pg.screenshot({path:'screenshots/pk_gavimas2.png',fullPage:false}); files.push('screenshots/pk_gavimas2.png');
