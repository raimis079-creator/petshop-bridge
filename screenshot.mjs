...
(async()=>{
  ...
  await page.goto('https://dev.avesa.lt/?p=34172&nc='+Date.now(),{waitUntil:'domcontentloaded',timeout:50000}).catch(()=>{});
  ...
  commit('mix_probe.json', JSON.stringify(probe,null,1));
  putBin('mix_visual.png', await page.screenshot({fullPage:false}));
