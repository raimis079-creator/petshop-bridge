...
const pcode=Buffer.from("",'base64').toString('utf8').trim();
(async()=>{
  ...
  var m=r.match(/(\{.*\})/s); commit('preset_full.json', m?m[0]:(r||'').slice(0,1500)); console.log('matched',!!m,r.length);
