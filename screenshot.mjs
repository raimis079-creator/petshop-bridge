...
try{
  ...
  const c=await fx(SNIP,{method:'POST',headers:A,body:JSON.stringify({name:'TEMP PS Katalogo Diegimas v1.5c (cache-bust)',
...
await put('analize/dieg8_status.json', Buffer.from(JSON.stringify(out,null,1)), VER);
console.log('ok');
