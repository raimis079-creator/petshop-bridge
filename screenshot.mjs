...
let html='';try{html=execSync('curl -s -k --max-time 45 "'+BASE+'/kategorija/sunims/"',{encoding:'utf8',maxBuffer:30000000});}catch(e){html='ERR '+e;}
putText('landing_html.txt', html);
