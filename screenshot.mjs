...
try{
  ...
  await ctx.addCookies([{name:P.cookie_name,value:P.cookie,domain:'dev.avesa.lt',path:'/'},{name:P.auth_name,value:P.auth_cookie,domain:'dev.avesa.lt',path:'/wp-admin',secure:!!P.auth_secure},{name:P.auth_name,value:P.auth_cookie,domain:'dev.avesa.lt',path:'/wp-login.php',secure:!!P.auth_secure}]);
