...
(async()=>{
  const c=api('POST','/wp-json/code-snippets/v1/snippets',{name:'Clean200',desc:'x',code:SETUP,scope:'global',active:true,priority:6});
  let sid=0;try{sid=JSON.parse(c).id;}catch(e){}
  execSync('sleep 2');
  putText('clean200.txt', sh('curl -s -k -A "Mozilla/5.0" --max-time 30 "'+BASE+'/?ps_cleanup=1&token=cmplz_6680aa2a42151d54fa8d64ec"'));
