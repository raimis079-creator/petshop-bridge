...
const j=cj(`${BASE}/wp/v2/product/14535?context=edit&_fields=id,sku,title,content`);
const raw=(j.content&&j.content.raw)||"";
commit("farmina_dump_14535.json",JSON.stringify({id:j.id,sku:j.sku,title:(j.title&&j.title.raw)||"",len:raw.length,raw},null,1));
