...
try{
  ...
  const puslapiai=[
    ['s1547g_at','/wp-admin/admin.php?page=ps-atsargos&saltinis=abu&f_brendas=animonda'],
    ['s1547g_at_gal','/wp-admin/admin.php?page=ps-atsargos&tab=galiojimas&saltinis=abu&f_brendas=animonda'],
  ];
