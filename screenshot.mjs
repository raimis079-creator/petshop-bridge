...
if(!ok){commit("prins_b2b_"+Date.now()+".json",JSON.stringify({abort:1,rep},null,1));console.log("ABORT");process.exit(0);}
const wres={};
...
commit("prins_b2b_"+Date.now()+".json",JSON.stringify({rep,wres},null,1));
