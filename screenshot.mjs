...
for(const r of rows){ const id=r[1],nm=r[2],st=r[4],tp=r[5]; if(st==='REVIEW'){ review.push(id+' '+nm.slice(0,44)); } else { (byTipas[tp]=byTipas[tp]||[]).push(id+' '+nm.slice(0,30)); } }
out.byTipas={}; for(const k of Object.keys(byTipas)) out.byTipas[k]={n:byTipas[k].length, items:byTipas[k]};
out.review=review;
