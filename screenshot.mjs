...
const B64=''; const SHA='b969516b5a1285360872828a87348fd5d91d79c9'; const MD5='069a72ae7ad8f38d4a0e36e0689881d0';
const out={v:'H293A'}; const miegok=ms=>new Promise(r=>setTimeout(r,ms));
...
let sid=null;
try{
  const c=await fx(SNIP,{method:'POST',headers:A,body:JSON.stringify({name:'TEMP H290 v1 (rinkiniai v1.37)',code:Buffer.from(B64,'base64').toString('utf8'),scope:'global',active:true,priority:5})},'snip');
  const j=JSON.parse(await c.text()); out.sukurta=j.id; sid=j.id; await miegok(9000);
  const d=await fx(WP+'/?ps_h293=RUN20260825AC&deploy=1&sha='+SHA,{},'deploy');
  ...
  if(out.md5_ok&&cookies.length){
    ...
    out.js=kl;
    out.put=await put('screenshots/h293_admin.png',await pg.screenshot({fullPage:false}),'H293A');
    await br.close();
  }
...
await put('screenshots/h293run.json', Buffer.from(JSON.stringify(out,null,1)), 'H293A');
