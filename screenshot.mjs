...
const r=JSON.parse(execSync(`curl -sk --max-time 30 -u "$WP_USER:$WP_PASS_CLEAN" "https://dev.avesa.lt/wp-json/wp/v2/product/27130?context=edit&_fields=content"`,{encoding:'utf8',env,maxBuffer:20000000}));
const h=(r.content&&r.content.raw)||'';
putResult('read27130_'+TS+'.json', JSON.stringify({ts:TS, len:h.length, full:h}));
