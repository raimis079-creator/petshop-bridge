...
try{
  ...
  const c=await fx(SNIP,{method:'POST',headers:A,body:JSON.stringify({name:'TEMP PS Katalogo Diegimas v1.6 (formos stilius)',
...
await put('analize/dieg9_status.json', Buffer.from(JSON.stringify(out,null,1)), VER);
console.log('ok');
