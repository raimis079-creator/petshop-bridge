...
for(const id of [19751, 19747]){
  ...
  out.items.push({
    ...
    good_imgs:(h.match(/src="data:image\//gi)||[]).length,
    has_analitines:/Analitin\u0117s\s+sudedamosios/i.test(h),
    has_serimo_instr:/\u0160\u0117rimo\s+instrukcija/i.test(h),
    has_maitinimo:/Maitinimo\s+norma/i.test(h),
    has_sudetis:/Sud\u0117tis\s*:/i.test(h)
  });
}
putResult('verify_'+TS+'.json', JSON.stringify(out,null,2));
console.log('done');
