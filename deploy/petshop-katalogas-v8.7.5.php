<?php
/**
 * Petshop Katalogas v8.7.5 (S1641) - variacines prekes KAINA saraso eiluteje.
 *
...
class Petshop_Katalogas {
	...
	public static function surinkti() {
		...
		foreach ( $eil as $r ) {
			...
			/* v8.7.5: variacinei prekei WC tevo `_regular_price` isvalo -
	...
	private static function meta_masinis( $ids ) {
		...
		$raktai = array(
			...
			/* v8.7.5: `_price` — variacines prekes tevo kainos atsarginis kelias */
			'_price',
