...
class Petshop_Relaunch {
	...
	public static function init() {
		...
		add_filter( 'petshop_welcome_modal_show', array( __CLASS__, 'be_modalo' ) );
	}

	/** S1688: atėjus iš laiško (?svoris / cid / ps_primink_ok) „atsinaujino" modalo nerodyti — laiškas jau tai pasakė, o modalas uždengia skaičiuoklę ir priminimo bloką. */
	public static function be_modalo( $show ) { return ( isset( $_GET['svoris'] ) || isset( $_GET['cid'] ) || isset( $_GET['ps_primink_ok'] ) ) ? false : $show; }
