...
final class Petshop_Planas_Langas {
	const VER = '1.0.1'; const TEVAS = 'petshop-reports'; const PUSLAPIS = 'ps-planas'; const T0 = '2026-09-09';
	...
	private static function men_tikslas() { $k = (int) ceil( (int) date( 'n' ) / 3 ); $key = date( 'Y' ) . '-' . $k; $kt = isset( self::N_KETV[ $key ] ) ? self::N_KETV[ $key ] : ( $key < '2026-4' ? 120 : 250 ); $men = $kt / 3;
