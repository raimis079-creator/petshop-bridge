<?php
/**
 * Plugin Name: Petshop GSC tvarka v1.0 (S1711)
 ...
 *   (2) WooCommerce Product schema neišvedama archyvuose (gamintojai/kategorijos) — GSC „Reikia nurodyti offers";
...
class Petshop_GSC_Tvarka {
	...
	/** Senas kelias → [tipas, id]: p = prekė, c = product_cat, b = product_brand slug, pc = prekės kategorija. */
	const KELIAI = array(
