<?php
/**
 * Šablonas: refill_due — „Pakartoti užsakymą" v1.4 (S1685, Raimio tekstas 09-15): visos paskutinio užsakymo sekamos maisto prekės su miniatiūromis, kiekiais, kainomis, suma; vienas stiprus mygtukas į kasą (Petshop_Pakartoti::url).
...
$subject = 'Laikas papildyti atsargas';
