...
class Petshop_Pakartoti {
	...
	/** S1688: sekimas be WC užsakymo (relaunch priminimas iš prekės puslapio) — grupė iš vienos prekės ×1, kasa = add-to-cart. */
	...
	public static function grupe( $uid, $pid ) {
		...
		if ( ! $r ) return null;
		$oid = (int) $r['last_order_id']; $o = wc_get_order( $oid ); if ( ! $o ) return self::grupe_preke( $uid, $pid, $r );
