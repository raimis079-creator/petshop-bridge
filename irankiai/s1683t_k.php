<?php
/** TEMP PS S1683t k — read-only: #1053 — statusas, siuntimas, meta (_ps_*, venipak/lp klaidos), pastabos, fakt_siuntos, darbalaukio siuntos_klaida. */
add_action('init', function(){
  if (!isset($_GET['ps_s1683tk'])) return; global $wpdb; $p=$wpdb->prefix; $o=array('v'=>'S1683t k');
  $id=$wpdb->get_var("SELECT order_id FROM {$p}wc_orders_meta WHERE meta_key='_ps_order_number' AND meta_value='1057'"); $w=wc_get_order($id);
