...
add_action('init', function(){
  ...
  $opt=array('ps_s1617_test','ps_audit_ids','ps_e3_oid','ps_e3_oid2','ps_s1621_oid','ps_s1621b_oid','ps_audit_mail','ps_dev_pastas_zurnalas');
  ...
  if($f==='A'){
    $ids=$orders(); $ref=$refunds(); $o['pries']=array('uzs'=>count($ids),'ref'=>count($ref));
