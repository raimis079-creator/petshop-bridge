...
add_action('wp_loaded', function(){
  if(!isset($_GET['ps_s1717o'])) return;
  $f=$_GET['ps_s1717o']; @set_time_limit(170); global $wpdb; $P=$wpdb->prefix; $r=['v'=>'S1717o','faze'=>$f]; $ID=36296; $BAK='ps_s1717_1177_bak';
  $tz=new DateTimeZone('Europe/Vilnius'); $dabar=current_time('mysql');
  $PLANAS=[ 2578=>['src'=>'ambrosia','car'=>'venipak','pid'=>19760,'q'=>1,'wc_red'=>1,'av'=>0], 2579=>['src'=>'av','car'=>'any','pid'=>18468,'q'=>1,'wc_red'=>null,'av'=>1], 2580=>['src'=>'av','car'=>'any','pid'=>15867,'q'=>4,'wc_red'=>null,'av'=>4] ];
