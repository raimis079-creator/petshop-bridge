/**
 * PETSHOP ADS KONVERSIJŲ RECON v1.2 (S1673, C etapas) — TIK SKAITO, nieko nekeičia.
...
var NUO = '2026-09-01', IKI = '2026-09-12';

function main() {
  var out = { v: 'ADS KONV RECON v1.2', kada: new Date().toISOString(), klaidos: [] };
