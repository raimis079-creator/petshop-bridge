/**
 * PMax D v1.1 (S1676, URL gamintojas) — nauja struktūra: pervadina šunų kampaniją, €40/d, URL expansion OFF,
...
function main() {
  var out = { v:'PMAX D v1.1', dry:DRY, kada:new Date().toISOString(), klaidos:[], zingsniai:[] };
  try {
