/**
 * PETSHOP ADS PMAX ASSET INVENTORIZACIJA v1.0 (S1671) — TIK SKAITO, NIEKO NEKEIČIA.
...
function main() {
  var out = { v: 'ADS ASSET INV v1.0', kada: new Date().toISOString(), klaidos: [] };
  ...
  out.turtas = gaql(out, 'turtas',
    ...
    'asset_group_asset.status, asset_group_asset.performance_label, asset_group_asset.primary_status, ' +
