/**
 * PMax D v1.3 (S1676: listing filtrų sudėtiniai temp ID -1~-N; tekstai ribojami 5/3/4, nuotraukos atskiru mutate partialFailure, be urlExpansion) — nauja struktūra: pervadina šunų kampaniją, €40/d, URL expansion OFF,
...
function main() {
  var out = { v:'PMAX D v1.3', dry:DRY, kada:new Date().toISOString(), klaidos:[], zingsniai:[] };
  try {
