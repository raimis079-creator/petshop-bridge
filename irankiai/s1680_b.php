<?php
/** TEMP PS S1680 b — darbalaukis v3.41.2 DEPLOY iš media (fazė D) + patikra (fazė T). */
add_action('init', function(){
  if (!isset($_GET['ps_s1680b'])) return; global $wpdb; $p=$wpdb->prefix; $F=$_GET['ps_s1680b']; $o=array('v'=>'S1676 j','faze'=>$F);
  $o['temp_istrinta']=(int)$wpdb->query("DELETE FROM {$p}snippets WHERE name LIKE 'TEMP%' AND active=0");
  $f=WPMU_PLUGIN_DIR.'/petshop-darbalaukis.php'; $bk=wp_upload_dir()['basedir'].'/ps-backups/petshop-darbalaukis.php.bak_s1680';
  if($F==='D'){
    $mid=isset($_GET['d_dl_v3412_txt'])?(int)$_GET['d_dl_v3412_txt']:0; $mf=$mid?get_attached_file($mid):''; $o['media']=array($mid,$mf?basename($mf):'NĖRA');
    ...
    if($o['senas_md5']!=='23a911c43994b154c54390de7d323d84'){ $o['STOP']='gyvas ne v3.41.1'; }
    elseif($o['naujas_md5']!=='0f714f6461cb4f349022d094723cbf6e'){ $o['STOP']='naujas md5'; }
