<?php
/** TEMP PS S1680 k — darbalaukis v3.43 DEPLOY iš media (fazė D) + patikra (fazė T). */
add_action('init', function(){
  if (!isset($_GET['ps_s1680k'])) return; global $wpdb; $p=$wpdb->prefix; $F=$_GET['ps_s1680k']; $o=array('v'=>'S1676 j','faze'=>$F);
  $o['temp_istrinta']=(int)$wpdb->query("DELETE FROM {$p}snippets WHERE name LIKE 'TEMP%' AND active=0");
  $f=WPMU_PLUGIN_DIR.'/petshop-darbalaukis.php'; $bk=wp_upload_dir()['basedir'].'/ps-backups/petshop-darbalaukis.php.bak_s1680k';
  if($F==='D'){
    $mid=isset($_GET['d_dl_v343_txt'])?(int)$_GET['d_dl_v343_txt']:0; $mf=$mid?get_attached_file($mid):''; $o['media']=array($mid,$mf?basename($mf):'NĖRA');
    ...
    if($o['senas_md5']!=='fc993421845c82eda30dbd4574f8a8dc'){ $o['STOP']='gyvas ne v3.42'; }
    elseif($o['naujas_md5']!=='8b2f896b2020fe09179e357b6729e264'){ $o['STOP']='naujas md5'; }
