...
### S1591–S1593 (2026-09-02, rytas–diena)
...
- **#26** Hosting cron: Import #3 processing `2 *` → `*/2 *` (Raimis).
...
```
TEMP: 4430–4437 (S1583–S1590) + 4438–4466 (S1591–S1593) deaktyvuoti → trinti WP admin (`TEMP% AND active=0`). Aukščiausias decision Nr.: **S1593**.
...
### ŽURNALO SPRAGA — S1547–S1582 (2026-08-29..09-01)

Sesijos S1547–S1549 (analitika: istorijos adapteris v1.1, filtrų baras, dropship rizika, email layout, „Tikėtini užsakymai") ir S1550–S1582 į šį failą neįtrauktos — įrašai tik TŽ MASTER v1.92 ir REGISTRAS. Papildyti iš sesijų suvestinių, kai bus surinktos.
...
### ŽURNALO SPRAGA — S1282–S1531 (2026-08-26..08-28)

Įrašai neperkelti į pilną failą (papildymų failų nėra). Šaltiniai: REGISTRAS v32–v34, TŽ MASTER v1.88–v1.92.
