# deployment_log.md — v1.3.67

## IRASAI (naujausi virsuje)

---

## 2026-07-14 — M8: DIZAINERIO ILIUSTRACIJOS [S200]

Emoji pakeisti dizainerio iliustracijomis (8 PNG). Vizualiai patvirtinta. S200.

### S200-A — 8 PNG failai gauti (dizaineris, ZIP)

7 avatarai (dog/cat/bird/rodent/fish/reptile/other) po 512x512 RGBA permatomi + pet-empty-state 600x400. Visi permatomi (alpha OK).

### S200-B — Ikelti i serveri

Bridge parsisiunte is repo raw -> irase i plugin assets/images/. Visi HTTP 200. Failai: pet-dog.png, pet-cat.png, pet-bird.png, pet-rodent.png, pet-fish.png, pet-reptile.png, pet-other.png, pet-empty-state.png.

### S200-C — Prijungti prie kodo

Pet_UI config +imagesUrl. pet-profile.js: speciesAvatar() helper — antrastes avataras, perjungiklis, empty state. pet-form.js: speciesImg() — anketos iliustracija (1+2 zingsnis), rezultato avataras. CSS: object-fit contain, overflow hidden, padding. Emoji lieka fallback jei imagesUrl tuscias.

### S200-D — Vizualus testas (browser=1)

Profilis: pspet-p-avatar img = 1 (Golden Retriever apvaliame avatare). Anketa: pspet-illustration img = 1 (suo virsuje). 0 JS klaidu. Screenshot patvirtinta — atrodo profesionaliai.

### S200 — LIVE

Iliustracijos gyvos anketoje + profilyje. Backup repo. Test duomenys isvalyti.

### S200 — SEKANTIS

- "Aktualu siandien" turinio blokas (12 kortelu JSON paruostas, laukia Raimio peržiuros)
