...
**Lieka:** kreditinė pusiau automatinė (recon PADARYTA — žr. žemiau; Raimio K1–K3) → „Sąskaita“ langas → Pragma (klausti). Faktų kodas `legacy` → `av` (jei Raimis nori — variklis, klausti). J1, Venipak 4/5/7/8, V12/V13/V14, T10/V1 — kaip S1614.
