# UŽSAKYMŲ DARBALAUKIS — SPECIFIKACIJA v1.18 (2026-09-06 naktis, po S1630 — §12.6 „Geriausia iki“ skelbimai → T1; v1.17 — rinkiklis, juosta be Tiekimo/Laiškų, „Gauta“ su savikaina; v1.16 — viena kortelė per tiekėją; ankstesnė v1.15: po 5 etapo #1–#4, „Siunta grįžta“ sumų, „Pakartotinio užsakymo“ su pavedimu, „Kreditinės“, „Sąskaitų“, A „Grąžinimo“, B „+ Naujo užsakymo“, **PPK „Pinigų priėmimo kvito“ ir C „Atsiėmimo AV“ (išjungtas)** — v3.35.1 + juosta v1.7 + tema base.php v2.12 — Raimio sprendimai iš S1607 + S1611 + S1614 + S1615 + 09-05 (K1–K3); §12.4 keičia §6c/§12.3, §12.5 — grįžusi siunta, pinigai, kreditinė, sąskaitos — VISKAS ĮGYVENDINTA S1616/S1617; C prielaidos a–c ir PPK kvitas Raimio PATVIRTINTI 09-06 (S1620); Pragma eksportas — Raimio sprendimas 09-06: NELIEČIAMAS, 1:1 kaip dabar, tema baigta; §12.6 — 5 etapas BAIGTAS, likučiai → T1, vertimai v1.2)
...
**Darbalaukyje („Siunta grįžta“ kortelė, po S1614 #3) — ĮGYVENDINTA S1616 v3.20:** kortelėje rodomos suskaičiuotos sumos, darbuotojas neskaičiuoja: „Klientui grąžink: [sumokėta] − 3,99 = X €“ (visa siunta grįžta → užsakymo suma su pristatymu; dalis → tik grįžusios dalies prekės su PVM — Raimis 09-05: „skirtumo nėra, suma nedidelė“) ir „**Pakartotinis užsakymas**: [įkainis] + 3,99 = Y €“ (įkainis — pasirinkto pristatymo metodo instance `fee`/`fixed_cost` + PVM; kitaip kaip sumokėta; kitaip 2,15 / 3,99). `GRAZINIMO_MOKESTIS = 3,99`. Atšaukus grįžusią siuntą (visą ar dalį) — žymė `_ps_grazinti_rankomis` su X → Klausimas „Grąžink klientui pinigus“ + „Grąžinta“ (kaip #4). Sumų taisymas rankomis — kai bus „Pakartotinis užsakymas“ forma (kitas žingsnis).
...
**„Pakartotinis užsakymas“ — ĮGYVENDINTA (S1617, darbalaukis v3.21 → v3.22, juosta v1.6; GALIOJA; Raimio sprendimai 09-05: viena virtuali paslaugos prekė „Pakartotinis siuntimas“ → AVPN įprastai, faktuose įprasta prekė; naujas užsakymas darbalaukyje NERODOMAS; apmokėjus — įvykdomas pats su AVPN laišku, pradiniame „Siųsti iš naujo“).** Klausimų kortelėje „Siunta grįžta“ vietoj „Siųsti iš naujo“ — mygtukas „Pakartotinis užsakymas“ → forma `Suma [Y] € (įkainis + 3,99 — taisyk, jei reikia) · Sukurti ir siųsti nuorodą · Be mokesčio · atgal`. „Sukurti“: naujas mažas užsakymas (svečio, tas pats adresas / el. paštas, `created_via=darbalaukis`, eilutė „Pakartotinis siuntimas už užsakymą #N“ su PVM = Y, meta `_ps_pakartotinis`=pradinio ID) + laiškas klientui su WC apmokėjimo nuoroda (tik Paysera). Apmokėjus (Paysera callback → `processing`) → naujas užsakymas `completed` be jokių WC laiškų, AVPN išsirašo tema, klientui darbalaukio laiškas „Apmokėjimas gautas — užsakymo Nr. N siuntą išsiųsime iš naujo“ su PVM sąskaita PDF; pradiniame pastaba/įvykis → kortelėje „Siųsti iš naujo“ (leidžiama tik apmokėjus arba pažymėjus „Be mokesčio“ — mūsų / vežėjo kaltė, 6.10). Kortelė ir skydelis rodo būseną („laukia apmokėjimo — nuoroda išsiųsta … · siųsti nuorodą dar kartą“ / „apmokėtas — galima Siųsti iš naujo“). „Atšaukti — prekės grįžo į AV“ / „Be mokesčio“ atšaukia neapmokėtą pakartotinį. Į Surinkti / lapus / Venipak neina; juosta neskaičiuoja. **Raimio sprendimai 09-05 (GALIOJA):** (1) užsakymas svečio — gerai (paskyroje nesimato); (2) **pavedimas reikia — ĮGYVENDINTA v3.23/v3.24:** apmokėjimo puslapyje Paysera + bankinis pavedimas, laiške ir „ačiū“ puslapyje rekvizitai (UAB Avesa · AB Swedbank · LT127300010124940593, paskirtis „Pakartotinis siuntimas, užsakymas Nr. N“), kortelėje „Apmokėta pavedimu“ — darbuotojas patvirtina gavęs pinigus → tas pats automatinis kelias (AVPN, laiškas, „Siųsti iš naujo“); pasirinkus pavedimą nuoroda toliau veikia (Paysera vis dar galima); (3) visi WC laiškai jam išjungti — taip; (4) „Be mokesčio“ — taip; (5) „Legacy niekur negali figūruoti“ — faktų kodas `legacy` yra variklio vidinis AV (savo sandėlio) žymuo visoms AV prekėms, niekur nerodomas; keisti — variklis, atskirai (klausti); (6) laiškų tekstai — gerai. „Pridėti prekę“ per tą patį mechanizmą — vėliau.

**Kreditinė — ĮGYVENDINTA (S1617, darbalaukis v3.25 + tema base.php v2.10; GALIOJA; Raimio sprendimai 09-05: K1 sava KR-AVPN eilė (tema liesti leista), K2 A — 3,99 € atskira paslaugos PVM sąskaita, K3 — per WC grąžinimo įrašą fone, klientui laiškas tik darbuotojo ranka).** Klausimų kortelėje „Grąžink klientui pinigus“ prie kiekvieno įrašo — „Kreditinė“ → juodraštis kortelėje (eilutės su taisomais kiekiais; pristatymas — varnelė, kai grįžo visa siunta; varnelė „3,99 € — atskira PVM sąskaita“, nežymėti dėl mūsų / vežėjo kaltės; gyva suma ir „klientui grąžinti X“) → „Patvirtinti kreditinę“: WC grąžinimo įrašas (pinigų nejudina, likučių neliečia, statusas nekinta), numeris KR-AVPN iš savos eilės (`petshop_kravpn_counter`, T-0 → 101), PDF (temos šablonas, Dompdf) — mygtukas „PDF“ kortelėje, grąžinimo faktai rašosi patys, 3,99 € — atskira sąskaita AVPN (paslaugos prekė „Siuntos grąžinimo išlaidos“, įskaitymas iš grąžinamos sumos, be laiško). „siųsti klientui“ — laiškas su kreditinės ir 3,99 € sąskaitos PDF (tik rankiniu). „Grąžinta“ įspėja, jei kreditinė neišrašyta. Kiekio mažinimo (#4) grąžinimams — ta pati „Kreditinė“ (WC įrašas jau yra). WC riba: jei suma po #4 mažinta ir atšaukiamas visas — WC gali neleisti pilnos kreditinės, darbalaukis rodo klaidą su sumomis (retas atvejis). Kreditinės numeracija vizualiai PATIKRINTA (KR-AVPN000101–103, REGISTRAS §8jj.1 uodega užsidaro).

**„Sąskaita“ — ĮGYVENDINTA (S1617, darbalaukis v3.26–v3.29, juosta v1.7; GALIOJA; Claude prielaidos — Raimis „tęsk“):** (1) skydelyje blokas „Sąskaitos“ — visi užsakymo dokumentai (išankstinė, PVM sąskaita, kreditinės, susietų paslaugų užsakymų — pakartotinio siuntimo / grąžinimo išlaidų — PVM sąskaitos): nr, data, suma, PDF čia; AVPN be failo — „sugeneruoti“ (temos generatorius); pilkas „Sąskaita“ mygtukas nuimtas (bloką pakeitė). (2) Langas „Sąskaitos“ (juostoje prie „Žurnalas“, `view=saskaitos`): visos PVM sąskaitos, išankstinės ir kreditinės viename sąraše — filtrai tipas / nuo–iki / paieška (nr., užsakymas, klientas, el. paštas), Data · Nr. · Tipas · Užsakymas · Klientas · Suma · PDF, apačioje skaičius ir suma pagal filtrą (kreditinės minusu) — buhalterei mėnesio pabaigai „išsitraukti bet kurią sąskaitą“. Darbalaukio refund'ai (`_ps_kiekis`, `_ps_kreditine`) — savi dokumentai: WC sumose ir kliento paskyroje / laiškuose nerodomi (v3.28/v3.29). Pragma eksportas (su kreditinėmis) — atskiras darbas, variklis, klausti.

**Raimio sprendimai 09-05 vakaras (GALIOJA; A ĮGYVENDINTA v3.32, B — v3.33.2 S1618, C — v3.35.1 S1619 išjungtas):** (A) grąžinimas ne dėl grįžusios siuntos — „Grąžinimas“ Klausimo „Klientas atsisako“ kortelėje ir įvykdyto užsakymo skydelyje: prekės/kiekiai + priežastis (atsisakymas / brokas / mūsų klaida) → kreditinė tuo pačiu mechanizmu → „grąžink X rankomis“; likutis — varnelė „tinkama prekybai“ (numatyta taip; brokas — ne); atsisakymas — grąžinamos prekės, pristatymas tik grąžinant visą užsakymą, 3,99 netaikoma (klientas pats siunčia); brokas / mūsų klaida — viskas be išskaitymų. (B) „+ Naujas užsakymas“ Užsakymų lango viršuje (telefoninis): klientas (paieška tel./el. paštu arba naujas; be el. pašto leidžiama), prekės (paieška pavadinimu/SKU, kiekis), pristatymas (Venipak kurjeris / paštomatas / LP / Atsiėmimas AV), kainos parduotuvės su akcijomis + nuolaida su pastaba, apmokėjimas — pavedimu (išankstinė + laiškas su rekvizitais ir nuoroda, Paysera galima) arba „Apmokėta vietoje“. (C) „Atsiėmimas AV“ (`local_pickup`): padaryti visą, bet IŠJUNGTĄ — kasoje neatsiranda, kol Raimis pats neįjungia; eiga: prekės į AV → Surinkti → be lipduko → laiškas „paruošta atsiimti“ (adresas, valandos — Raimis) → „Klientas atsiėmė“ → įvykdytas + sąskaita; apmokėjimas atsiimant — „Apmokėta vietoje“. (10) Kreditinės laiškas — taisomas šablonas (Sąskaitų lange), siunčia TIK darbuotojas — ĮGYVENDINTA v3.31. (11) Paslaugų sąskaitose be „Pristatymas: Nemokamas“ — ĮGYVENDINTA base.php v2.11. (14) Faktų kodas `legacy` = pasenęs AV pavadinimas („legacy kaip tokio neliko“) — keisti į `av` 6 etape (variklis, su leidimu).

**PPK „Pinigų priėmimo kvitas“ + „Apmokėta grynais“ + B (6) — ĮGYVENDINTA v3.34 (S1619, Raimio sprendimai 09-06; tema base.php v2.12 — leista):** „Apmokėta vietoje“ → **„Apmokėta grynais“** (kortelių nėra — terminalo nėra; `cod` + pavadinimas). Grynais apmokėtam užsakymui skydelio „Sąskaitos“ bloke mygtukas **„Suformuoti kvitą“** — darbuotojas spaudžia tuo metu, kai klientas moka (NE automatiškai): PPK sava eilė nuo 101 (`petshop_ppk_counter`, T-0 → 101), meta `_petshop_ppk_number/_date/_suma/_kas/_pdf`, PDF temos `base.php` `receipt` šaka (`uploads/wcdn/receipt/Kvitas-PPK000101.pdf`): UAB Avesa rekvizitai, mokėtojas (įmonė + vardas, kontaktas), paskirtis „Už prekes pagal užsakymą Nr. N, PVM sąskaita faktūra Nr. AVPN…“, suma skaičiais ir **žodžiais** (`suma_zodziais`), „Grynaisiais“, „Pinigus priėmė: [darbuotojas]“ + parašų linijos (ranka), be antspaudo. **Tik spausdinti** — el. paštu nesiunčiamas. Sąskaitų lange tipas **„Kvitas“** (į sumą neskaičiuojamas; data — kvito diena). **B (6):** telefoninio pavedimu užsakymo WC likutis nurašomas TIK apmokėjus (on-hold — ne; `woocommerce_payment_complete_reduce_order_stock` + `woocommerce_can_reduce_order_stock`); kasos bacs — nekeista. (7) laiške be Paysera nuorodos — nekeista; (8) LP el. paštas privalomas — kaip buvo.

**C „Atsiėmimas AV“ — ĮGYVENDINTA VISA, bet IŠJUNGTA v3.35 / v3.35.1 (S1619; Raimio sprendimai 09-05/09-06: adresas Liucionių g. 46, Liucionys; darbo laikas iš svetainės I–V 09:00–18:00, VI 10:00–15:00; laiško „paruošta atsiimti“ tekstas patvirtintas, 7 d.; taisomas šablonas):** jungiklis — **WC zonos „Lietuva“ `local_pickup` instancija #16 „Atsiėmimas AV — Liucionių g. 46, Liucionys“ (sukurta išjungta; Raimis įjungia WC → Pristatymas → atsiranda kasoje ir „+ Naujas užsakymas“ formoje)**. Atsiėmimo užsakymas (pristatymo eilutė `local_pickup`): visos prekės per AV (tiekėjo prekės — „veža į AV“, „siunčia klientui“ negalimas), lipduko žingsnio nėra: takelis Surūšiuota → Surinkti (lapas) → **„Paruošta atsiimti“** (laiškas klientui pagal šabloną — adresas, darbo laikas, 7 d.; varnelė „nesiųsti“; be el. pašto — paskambinti) → **„Klientas atsiėmė“** (įvykdytas, PVM sąskaita AVPN, savas laiškas su sąskaitos PDF — WC „įvykdytas“ laiškas atsiėmimui nesiunčiamas, jo tema „išsiųstas!“). Eilės: Surinkti → Paruošta. Neapmokėtam atsiėmimo užsakymui skydelyje **„Apmokėta grynais“** (klientas moka atvykęs → cod + processing → surinkimas; pavedimas gautas — „Pažymėti apmokėtu“ kaip visada); kvitas PPK — atskirai. Šablonas `ps_dl_ats_laiskas` (Sąskaitų lange): tema, tekstas, `{neapmoketa}` pastraipa, adresas, darbo laikas, „atsiimta“ laiško tema/tekstas. Skydelis rodo „Atsiėmimas AV“, „Redaguoti“ nėra; filtras „Pristatymas“ + „Atsiėmimas AV / kita“. **Raimio PATVIRTINTA 09-06 (S1620; buvo Claude prielaidos):** (a) neapmokėtas atsiėmimo užsakymas į darbą neina (kaip visi; klientas moka atvykęs → „Apmokėta grynais“ → surinkimas prie kliento); (b) po „Klientas atsiėmė“ — savas laiškas su PVM sąskaitos PDF (tekstas — Claude siūlymas, taisomas Sąskaitų lange), WC „išsiųstas!“ laiškas išjungtas; (c) jungiklis — WC zonos instancija #16 (išjungta), ne opcija (`ps_dl_atsiemimas_av` nebenaudojama); (d) PPK kvito išvaizda (log S1619 PNG) — patvirtinta. **Priedo patikra (S1620, `pre_wp_mail` prior. 4, #35813):** „paruošta atsiimti“ laiškas priedų NETURI (`attachments=''` — WC `WC_Emails::send()` numatytoji reikšmė; dev-pastas v1.0 skaičiavo `count((array)'')=1` — klaidingas skaičius, ne priedas); „atsiimtas“ laiškas — 1 tikras priedas `PVM-saskaita-AVPN000341.pdf`. Dev-pastas v1.1 — skaičiuoja tik tikrus failus, rodo vardus.

**A „Grąžinimas“ — ĮGYVENDINTA v3.32 (S1618):** mygtukas „Grąžinimas“ Klausimo „Klientas atsisako“ kortelėje (forma kortelėje) ir įvykdyto (arba atsisakančio) apmokėto užsakymo skydelio footer'yje (forma pristatymo bloke). Forma: priežastis (atsisakymas / brokas / mūsų klaida), eilutės su likusiu kiekiu (`q − _ps_grazinta_q`, be `_ps_atsaukta`/`_ps_kreditine`), pristatymas (atsisakymas — tik grąžinant VISĄ likutį, JS užrakina; brokas / klaida — pagal varnelę), „tinkama prekybai“ (brokas → nusiima). POST `ps_dl_grazinimas`: likutis grįžta kaip #4 (`_ps_av_reduced_qty` → AV, `_reduced_stock` → WC; tiekėjo prekė be nurašymo — nekeičiama), WC grąžinimo įrašas be pinigų → KR-AVPN + PDF tuo pačiu kreditinės mechanizmu, 3,99 € niekada, eilutėse `_ps_grazinta_q` (pilnai → `_ps_kreditine`), įrašas `_ps_grazinti_rankomis` su `kr` → Klausimas „Grąžink klientui pinigus“ (PDF · siųsti klientui · Grąžinta). Laiško klientui nėra — siunčia darbuotojas. Testas: #35777 → KR-AVPN000104 (refund #35800).

**B „+ Naujas užsakymas“ — ĮGYVENDINTA v3.33.2 (S1618):** nuoroda eilių juostoje → langas `view=naujas`: 1) klientas (paieška tarp ankstesnių pirkėjų telefonu / el. paštu / vardu — užsakymų adresai + vartotojai; be el. pašto leidžiama, LP Express — privalomas), 2) prekės (paieška pavadinimu / SKU; kaina su PVM su akcija, AV ir WC likutis; kiekis ir kaina taisomi; nuolaida € su privaloma pastaba, skirstoma proporcingai eilutėms), 3) pristatymas (Venipak kurjeris pagal svorį / Venipak paštomatas / LP paštomatas / LP kurjeris; „Atsiėmimas AV“ — kai WC zonos „Lietuva“ `local_pickup` instancija įjungta — C, v3.35) su numatyta parduotuvės kaina ir nemokamo riba (taisoma), paštomatų sąrašas su paieška, 4) apmokėjimas: pavedimu (bacs + on-hold; klientui temos laiškas su išankstine IAPV ir rekvizitais, kai yra el. paštas; gavus — „Pažymėti apmokėtu“) arba „Apmokėta vietoje“ (processing iš karto — varikliai kaip po Paysera). Užsakymas `created_via=darbalaukis`, meta `_ps_telefonu`, `_ps_nuolaida(_pastaba)`, eilutėse `_ps_kaina_pakeista`; toliau eina įprastai (Gauti → Surinkti → lipdukas). Testai: #35806 (pavedimu, paštomatas 3648), #35807 (vietoje, kurjeris).
...
**Sąskaitų saugojimas ir buhalterija (Raimis: Pragma — buhalterės programa, mes tik siunčiam duomenis; „paprasčiausiai — gale mėnesio su visomis sąskaitomis kartu per ataskaitą Pragmai“; sistemoje turi būti galimybė atsifiltruoti / išsitraukti bet kurią sąskaitą, visos saugomos):** AVPN/IAPV PDF jau saugomi (`uploads/wcdn/invoice/`, meta `_petshop_completed_pdf` / `_petshop_order_pdf`), kreditinės — `uploads/wcdn/creditnote/`. 5 etapo **„Sąskaita“** punktas = darbalaukio langas: visų dokumentų sąrašas (AVPN / IAPV / KR-AVPN) su filtrais (nr., data, klientas, suma, tipas), atsisiuntimas, mygtukas skydelyje (dabar pilkas „dar nepadaryta“). **Pragma eksportas** (`petshop-pragma`, 5 d., dabar tik AVPN užsakymai) — ~~papildyti kreditinėmis~~ — NEBEDAROMA (Raimis 09-06: neliesti). **Recon S1620 (tik skaitymas; `plugins/petshop-pragma/petshop-pragma.php` v1.0.0, 22 662 B, 532 eil., aktyvus, prod mode OFF → kas mėn. „PRALEISTAS“ žurnale nuo 06-05; `wp_schedule_single_event` 5 d. 08:00 serverio laiku = 11:00 LT, kitas 2026-10-05):** imami `completed` užsakymai pagal **`date_created`** praėjusio mėnesio ribose su `_petshop_invoice_document_type=invoice` ir AVPN; failai `imones` (klientai), `pardavimai` (eilutė: užs. nr · dok. tipas **2** = PVM sąskaita · data = `date_paid` (arba sukūrimo) · AVPN · kliento ID · suma su PVM · PVM · be PVM (`get_subtotal`) · mokestis „smulkaus/krepšelio“), `pardavimai_sum`; laiškas `info@audac.lt` (prod) / `terra@petshop.lt` (test) + naujų klientų sąskaitų PDF; kopija terra@. **Nėra:** KR-AVPN kreditinių (WC refund + `_ps_kreditine` niekur), PPK kvitų (ne sąskaita), `date_completed`/AVPN datos filtro (užsakymas sukurtas VIII, įvykdytas IX → VIII eksportas 09-05 jo nemato, IX — irgi ne: `date_created` VIII) — **Raimio sprendimas 09-06 (GALIOJA): Pragma NELIEČIAMA — perdavimo forma suderinta su buhalterija, lieka 1:1; kreditinės ir kvitai — buhalterė rankomis; tema baigta.**

**#4 „kiekiai“ — ĮGYVENDINTA (S1616, darbalaukis v3.19.1; GALIOJA).** Skydelio eilutės „q×“ tampa spaudžiamas, kai eilutė be užrakto (nėra lipduko, tiekėjui nepranešta, kaupiama Tiekimo partija ne užsakyta, nesurinkta) ir užsakymas apmokėtas → forma eilutėje „Kiekis [n] × iš q · Išsaugoti · Išimti“ (dialogas prieš). `kiekis_vykdyti`: (1) likutis grįžta (AV pagal `_ps_av_reduced_qty`, WC veidrodis pagal `_reduced_stock`, `_restock_refunded_items += d`); (2) `wc_create_refund` su eilute (`refund_payment=false`, `restock_items=false`, meta `_ps_kiekis`) — laiškai off; nepavykus — viskas atgal; (3) eilutė perrašoma (`set_quantity`, proporcingos sumos, **`update_taxes()` + `calculate_totals(false)`** — vien `calculate_totals` PVM iš eilučių nesumuoja, v3.19 klaida) arba išimama (`remove_item`; vienintelės išimti negalima → „Atšaukti“); kaupiama partija perdedama; grupės/planas; `_ps_surinkta` nuimama; (4) žymė `_ps_grazinti_rankomis` → Klausimas **„Grąžink klientui pinigus“** (kortelė su suma + „Grąžinta“ = `v=grazinta`, nuima žymę; galioja ir įvykdytam/atšauktam). Klientui laiško nėra; partijos — rankomis (pastaba). WC refundą po perrašymo rodytų dukart → 4 filtrai nuima `_ps_kiekis` refundus (paskyra, laiškas, „Refund“ eilutė totaluose, „Suma“). Pasekmė: WC `get_remaining_refund_amount()` po keitimo mažesnis už realų — WC admin refundų nenaudojam; kreditinė („Sąskaita“) skaičiuos iš savų sumų. „Pridėti prekę“ — vėliau per „naują mažą užsakymą + nuoroda“.
...
## 12.6. Raimio sprendimai S1620 (2026-09-06) — 5 etapas BAIGTAS; likučiai → T1 (po paleidimo)

- **Pragma** — neliečiama, 1:1 (žr. §12.5). Kreditinės ir PPK kvitai — buhalterė rankomis.
- **„Pridėti prekę“ (§6c 4 p., §11.3) — T1.** Paruoštas variantas (Claude, S1616/S1620): apmokėto užsakymo neliesti; iš skydelio „Pridėti prekę“ → naujas mažas **susietas** užsakymas (kaip „Pakartotinis“, meta `_ps_pakartotinis`-tipo nuoroda į pradinį) su tikra preke → klientui laiškas su apmokėjimo nuoroda (Paysera / pavedimu, kaip v3.23) → apmokėjus eina įprastai; jei pradinis dar be lipduko — galima siųsti kartu (darbuotojas sprendžia). Reikės Raimio: (1) ar iš viso (B „+ Naujas užsakymas“ jau leidžia sukurti naują telefonu); (2) nuoroda ar „sumokės kurjeriui“; (3) kartu ar atskirai. Kol kas — darbuotojas naudoja B.
- **Paskyros UI lokalizacija — T1**, bet esami angliški tekstai verčiami iš karto: recon S1620 (e3r) — visi paskyros puslapiai LT; vienintelis rastas — WC `form-verify-email.php` (svečio užsakymo puslapis po 10 min.) → **`petshop-vertimai.php` v1.2** (2 sakiniai), vizualiai patikrinta. T1 recon — Playwright kadrai visų paskyros langų + „Kaip mato klientas“, ką dar gerinti (Raimis pasako).
- **„Kaip mato klientas“ svečiui — T1:** po 10 min. darbuotojas mato WC el. pašto patvirtinimo formą, ne užsakymą; siūlymas — `woocommerce_order_email_verification_required` → `false` darbuotojui (darbalaukyje).
- **„Geriausia iki“ skelbimai parduotuvėje — T1 (Raimio sprendimas S1630, 09-06 naktis: „automatikos negali būti tik pusiau — su darbuotojo priežiūra“; modelis TŽ 38.5/38.6).** Būklė: gyva — partijos su `geriausia_iki` (FEFO), katalogo eilė „Artėja geriausia iki“ (v5.8, spalvos/filtrai), darbalaukio „Gauta“ galiojimo laukas → partija, akcijų taikinys „Geriausia iki“ v1.8 (nuolaida VISAI prekei — TŽ 38.5 problema, t. y. netinka partijos likučiui). Nepadaryta — TŽ 38.5 **atskiras skelbimas**: iš katalogo eilės „Sukurti skelbimą“ → nauja prekė partijos likučiui (likutis PADALIJAMAS, galimas dalinis), data pavadinime, kaina užpildoma taisykle, darbuotojas koreguoja kiekį/kainą per prekę, meta ryšys su pagrindine, savo kategorijoje su žyma, paieškoje TAIP, Google noindex; abipusės nuorodos (skelbime „Reikia įprastos datos? →“, pagrindinėje „Turime pigiau su trumpesne data →“); cron: išparduota / data praėjo → juodraštis + adresas į pagrindinę. TŽ 38.6 — `/pasiulymai/` trečia kortelė „Geriausia iki“ (tekstas iš TŽ) + `/pasiulymai/geriausia-iki/`. Apimtis ~2 sesijos (skelbimo kūrimas ~1, puslapis + nuorodos ~½, cron ~½); kartu spręsti 6 slug konfliktų klausimą (`pasiulymai` puslapis vs kategorija — REGISTRAS). Prieš kodą — recon: `petshop-katalogas.php` eilė, `Petshop_Partijos` (variklis — klausti), `petshop-akcijos.php` taikinys, Flatsome `/pasiulymai/` puslapis.
- **Raimio pastebėjimai admin'e (09-06) — ĮGYVENDINTA S1620:** v3.35.2 — sąraše pilnas prekės pavadinimas (svoris/pakuotė privalo matytis), „+ Naujas užsakymas“ tekstas baltas. **v3.36 (Raimis: „2 – ok, 3 – a ir b“):** filtrai „Visi“ lange — Data nuo–iki, Apmokėjimas (pavedimu / Paysera / grynais / neapmokėtas), Būsena, Suma nuo–iki, Rikiuoti „seniausi pirmi“; bet kuris filtras — naujausi 200 (ne puslapis), chips veikia kartu. **Atšauktų trynimas — tik NEAPMOKĖTI atšaukti** (be sąskaitos, refund'ų, siuntų; apmokėti su AVPN + KR-AVPN — niekada, buhalterijai reikia poros): (a) skydelio „Ištrinti“ ir filtro „Atšaukti“ „Ištrinti neapmokėtus atšauktus (N)“; (b) automatiškai kasdien 03:20 — senesni nei 30 d. → WC šiukšlinė, šiukšlinėje > 30 d. — galutinai. Trynimas = WC šiukšlinė (30 d. galima atstatyti).
- **Toliau — 6 etapas** (§10): E2E, testinių valymas, skaitikliai → 101, tikra darbuotojo paskyra, faktų `legacy` → `av` su leidimu.

## 12.7. Raimio sprendimai S1621 (2026-09-06 diena) — sisteminės klaidos: Laukiam / Dropshipping / Tiekimas dubliavosi (GALIOJA; ĮGYVENDINTA darbalaukis v3.37 → v3.37.1)

**Bandymas (Raimis: „praeik visą grandinę kaip darbuotojas“):** mišrus užsakymas AV (Grancarno ×4) + VF (Josera Mini Lamb ×1) → VF prekė į AV, kartu iš VF į atsargas Festival 12,5 kg ×2 ir Exclusion kiauliena 400 g ×6, vienas laiškas VF. Radiniai (log S1621): trys langai valdė tą patį „užsakymą tiekėjui“ — Laukiam B blokas (savas laiškas / „Kartu su Dropshipping“), Dropshipping kortelė („+ į AV“ varnelė, užraktas visiems dropship lipdukams), Tiekimo langas (atsargų eilutės). Raimis: „Laukiam langas dubliuojasi su Dropshipping langu, Tiekimo langas taip pat. Reikia taisyti.“

**Sprendimai (GALIOJA):**
1. **Terminas „Dropshipping“ lieka.**
2. **Jokių „tu/aš“ langų** — žmogus dirba su jam suteiktais įgaliojimais; atsargų į AV pridėjimas — kortelėje visiems, kam leista.
3. **Tiekėjui per sistemą — 1 laiškas dienai** (dienos laiškas = kortelės mygtukas); **antrą tą pačią dieną gali suformuoti ir išsiųsti tik darbuotojas** — tas pats mygtukas su įspėjimu „[T] šiandien jau užsakyta HH:MM — tai bus antras laiškas“. Lipdukų užraktas — tik pažymėtiems užsakymams; nepažymėti be lipduko lieka kitam laiškui.
4. **Kelio keitimas skydelyje** — kaip dabar: vieno sandėlio užsakymus rūšiuoja sistema, mišrius — darbuotojas.
5. **Partijų įspėjimas** („Partijose trūksta n vnt.“ AV prekei be partijų) — kelias (b): **T-0 pradinio likučio partija kiekvienai AV prekei** (kiekis = likutis, savikaina iš kortelės; savikainas Raimis sudeda iki paleidimo). Iki tol įspėjimai lieka.

**Kaip veikia (v3.37.1):** eilė **Dropshipping** = viena kortelė per tiekėją: „Siunčia klientui“ (dropship užsakymai, varnelės, Lipdukai) · „Veža į AV“ (užsakymų eilutės su varnelėmis + kaupiamos partijos „į atsargas“ eilutės) · „į atsargas“ (prekė/SKU su paieška, kiekis, „Pridėti“) · „Kaip atkeliaus į AV“, svoris, dėžės · **„Užsakyti iš [T] (n užs. + m prek. į AV)“** — vienas laiškas (yra dropship → variklio dropship laiškas su partija; nėra — savas Tiekimo laiškas; ZB — be laiško, „Kopijuoti“) · „Peržiūrėti laišką“ pilnas. Eilė **Laukiam iš tiekėjų** = tik užsakyta → „Gauta“. „Veža į AV“ neužsakyta → Dropshipping; užsakyta → Laukiam; gauta → Surinkti AV (kai visos). Rytinė eiga: „Lipdukai ir laiškai tiekėjams“ + „Užsakyti į Avesą“ = vienas žingsnis. Tiekimo langas darbuotojo kelyje nebėra (Raimiui — istorija).

**T-0 sąrašas papildytas:** pradinio likučio partijos visoms AV prekėms (5).

## 12.8. Raimio sprendimai S1623 (2026-09-06 vakaras) — juosta, prekės sau, savikaina (GALIOJA; ĮGYVENDINTA darbalaukis v3.38, juosta v1.8, variklis tiekimas v1.10)
1. **Juostoje „Tiekimas“ ir „Laiškai“ — nereikalingi** („Ne noriu, o reikia“): išimti. Išsiųstų laiškų archyvas — darbalaukyje (`view=laiskai`, nuoroda Dropshipping apačioje). Langai lieka tiesiogine nuoroda (istorija). Juosta: Užsakymai · Rytinė eiga · Prekės · Gavimas · Rinkiniai · Akcijos.
2. **Prekės sau (be kliento užsakymo):** Dropshipping eilės viršuje „Užsakyti į atsargas iš: VF · ZB · Prins · Belacor · Quattro · Ambrosia“ → tiekėjo kortelė → **rinkiklis kaip kataloge, ne paieška iš atminties**: Ženklas (tik to tiekėjo) · „išparduota (reikia užsakyti)“ · paieška sąraše → lentelė su pakuote, SKU, AV likučiu, tiekėjo likučiu (VF), paskutiniu gavimu, savikaina, kaina, varnele ir kiekiu → „Pridėti pažymėtas (n)“. Eilutės kortelėje taisomos (kiekis, ×). Laiškas — tas pats „Užsakyti iš [T]“ (be dropship — savas Tiekimo laiškas). Prekių [reikia užsakyti] atskiro mygtuko nereikia — tas pats per „išparduota“.
3. **„Gauta“ su savikaina** (leidimas varikliui): Laukiam „Gauta“ eilutėje savikaina € be PVM (numatyta iš paskutinės partijos / tiekėjo savikainos) → gavimo partija `ps_partijos` (savikaina, galiojimas, `tiekimas_id`) — vienas priėmimo kelias su Gavimu; be savikainos — tik likutis. Kartu su T-0 pradinėmis partijomis (§12.7 p.5) „Partijose trūksta“ nebelieka.
