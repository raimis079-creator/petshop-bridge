...
| 2.16 | **Atsiliepimai**: WC atsiliepimai + prašymas post_purchase_7d laiške + `aggregateRating` schemoje; „Atsiliepimai“ puslapis (zoosalis/pethappy turi). ~~Senų eShoprent atsiliepimų importas (TŽ Q19)~~ — **✗ R 09-25: senų atsiliepimų nėra, prieigos prie senos bazės nėra** | R sprendimas → C | ≥ 30 atsiliepimų iki 12-31 | ☐ laukia R taip/ne dėl WC atsiliepimų + laiško |
...
- **2.16** atsiliepimų sprendimas (tik WC atsiliepimai + laiškas; senų importas ✗) — laukia
