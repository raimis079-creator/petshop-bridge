# 6 ETAPAS — TESTINIŲ DUOMENŲ VALYMO PLANAS v1.3 (recon S1620; **S1622 2026-09-06 — §1–2 VALYMAS ĮVYKDYTAS**, kopija `ps-backups/valymas-2026-09-06/`; A–H nelieta dalis — žr. §7)
...
## 7. Būklė po S1622 (2026-09-06 popietė) — kas padaryta, kas liko
- **PADARYTA (Raimis: „išvalyk senus“):** visi §1 užsakymai (66 + 8 refund'ai) ir §2 lentelės ištrintos, WC našlaičiai išvalyti, `wc_customer_lookup` testiniai (26) išvalyti, PDF (93/4/2) **perkelti** į `ps-backups/valymas-2026-09-06/wcdn/`, opcijos `ps_s1617_test`, `ps_audit_ids`, `ps_e3_oid*`, `ps_s1621*_oid`, `ps_audit_mail`, `ps_dev_pastas_zurnalas` ištrintos; `ps_web_dienos` `aplinka='dev'` 423. Įrankis — `irankiai/s1622_valymas.php` (D/A/Q, sargai, kopijos JSON.gz, LP/Venipak/variklių kabliai nuimti tik toje užklausoje) — **T-0 naktį pakartoti A** naujiems testiniams (#35816+).
- **LIKO (sprendimų):** **B** vartotojai (`wc_customer_lookup` liko #24 gutulis@gmail.com); **C** `ps_partijos` 10 (T-0 — pradinio likučio partijos visoms AV prekėms, spec §12.7); **D** augintiniai; **F** likučiai — 19475 `_stock` 40→26 (S1621+S1622 rezervai), 19708 16→15, 35357 6→4, AV 18154 3 / 18599 38 / 25411 0 / 19756 1 / 16889 1 / 16727 1 — atstatyti Raimio reikšmėmis (`Petshop_AV_Stock` + `_stock`, žurnalas); **G** skaitikliai → 101 (AVPN 350, IAPV 169, KR 105, PPK 103); **H** `legacy` → `av`; `ps_laisku_archyvas` (testiniai laiškai — išvalyti T-0); Venipak V07267E10000xx — Raimis savitarnoje.
- **Nauji testiniai (S1622 E2E, log S1622):** #35816–#35821, `ps_tiekimas` #18, opcija `ps_e2e_ids`.
