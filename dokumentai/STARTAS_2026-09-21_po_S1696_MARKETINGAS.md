...
| 1.7 | **Skaičiuoklė kaip atskiras puslapis — GYVA S1703 (09-22)**: https://petshop.lt/skaiciuokle/ (page #36142, index), mu-plugin `petshop-skaiciuokle.php` v1.0.0 — rūšis+svoris → visi maistai su gamintojo norma (tas pats `Petshop_Feeding_Service::calc`), TOP 3 perkamiausi, brendų filtras, lentelė €/d·€/mėn·norma, nuorodos į prekes su `?svoris=`, URL `?rusis=dog&kg=10`, FAQ schema + orientacinė lentelė, įvykis `skaiciuokle`, užsakymo meta `_ps_skaiciuokle_puslapis`. Rikiuojama pagal perkamumą (MASTER §6.7 — ne pagal pigumą; R sprendimas jei norės kitaip). 10 kg šuo: 179 maistai €0,22–2,98/d. Dokumentas `S1703_skaiciuokle_1.7_2026-09-22.md`. **Noindex nuimtas (R „daryk" 09-22): 26 puslapiai + 8 straipsniai → index, sitemap 56+8, bak `ps_s1703_noindex_bak`** | C ✓ / R | ses, `skaiciuokle` įvykiai, užs. su meta | ☑ (laukia R: rikiavimas, noindex) |
...
## Kitas langas
Sprintas 1 C darbai visi ☑ (1.1 S1697, 1.2 S1702, 1.3 S1698, 1.5 S1699, 1.6 S1700, 1.7 S1703, 1.8 S1701). **Pirma — R sprendimai:** (a) noindex ☑ padaryta (34 vnt., GSC perindeksavimas — laukti), (b) `/skaiciuokle/` rikiavimas (perkamumas — dabar / €/d), (c) 1.2 Bing MMC patvirtinimas (≤09-24), (d) 1.4 mėginukas, Josera Leger #18054, Ontario Exigent EAN. **Toliau C:** nuorodos į `/skaiciuokle/` (veislių puslapiai, meniu Sprendimai, 404, relaunch laiškas), tada Sprintas 2 — 2.5 konversijos auditas ir 2.1 veislių šablonas v2 (su skaičiuokle). Įrankių prefiksas `s1704_m*`.
