...
**Lieka (kitas langas):** „Siunta grįžta“ kortelės sumos (X − 3,99 „Klientui grąžink“ / įkainis + 3,99 „Pakartotinis pristatymas“, konstantos) → „Pakartotinis pristatymas“ = naujas mažas užsakymas + apmokėjimo nuoroda (§12.5; pirmas „Naujas užsakymas“ panaudojimas) → kreditinė pusiau automatinė (PIRMA recon: ką WCDN *creditnote* + `base.php` spausdina — refund eilutes ar visą užsakymą; KR-AVPN numeracija vizualiai) → „Sąskaita“ langas (sąrašas/filtrai/atsisiuntimas, mygtukas skydelyje dabar pilkas) → Pragma eksportas su kreditinėmis (variklio pluginas — klausti). „Pridėti prekę“ (§11.3) — per tą patį naujo užsakymo + nuorodos mechanizmą. J1 pirma reali LP siunta, Venipak 4/5/7/8, V12/V13/V14 variklis, T10/V1 — kaip S1614.
