...
- **Gyva dev'e:** darbalaukis **v3.35.1** (`4e8c1366…`), tema base.php **v2.12**, juosta v1.7, kliento-siuntos v1.3, **dev-pastas v1.1** (`ed7e80a8…`); variklis ir Pragma nekeisti. Instancija #16 išjungta. Skaitikliai AVPN 341 · IAPV 167 · KR-AVPN 105 · PPK 103 (T-0 → 101). Eilės Visi 64. Testiniai +#35813 (atsiėmimas, completed, AVPN000341) — trinti 6 etape.
- **Dokumentai:** log v1.9.27 (šis), spec v1.15 (§12.5 patvirtinimai + Pragma recon), STARTAS `dokumentai/STARTAS_2026-09-06_5_etapas_13_po_S1620.md`.
- **Kitas langas:** Pragma BAIGTA (neliesti) → 5 etapo likučiai („Pridėti prekę“ §11.3, paskyros UI lokalizacija) → 6 etapas.
