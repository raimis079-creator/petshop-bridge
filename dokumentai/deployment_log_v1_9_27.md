...
- **Gyva dev'e:** darbalaukis **v3.35.2** (`cc27c448…`), tema base.php **v2.12**, juosta v1.7, kliento-siuntos v1.3, **dev-pastas v1.1** (`ed7e80a8…`), **vertimai v1.2** (`8654dcc7…`); variklis ir Pragma nekeisti. Instancija #16 išjungta. Skaitikliai AVPN 341 · IAPV 167 · KR-AVPN 105 · PPK 103 (T-0 → 101). Eilės Visi 64. Testiniai +#35813 (atsiėmimas, completed, AVPN000341) — trinti 6 etape.
