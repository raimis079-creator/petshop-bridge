...
- **Dokumentai:** log v1.9.27 (šis), spec v1.15 (§12.5 patvirtinimai + Pragma; §12.6 T1 sąrašas), STARTAS `dokumentai/STARTAS_2026-09-06_5_etapas_13_po_S1620.md`.
- **Kitas langas:** 5 etapas BAIGTAS (likučiai → T1, spec §12.6) → **6 ETAPAS** (E2E, testinių valymas, skaitikliai → 101, tikra darbuotojo paskyra, faktų `legacy` → `av` su leidimu).
